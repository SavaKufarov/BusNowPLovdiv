        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AffectedLineId = table.Column<int>(type: "int", nullable: true),
                    AffectedRouteId = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DirectionA = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DirectionB = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FavoriteStops_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FavoriteLines_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FavoriteLines_TransportLines_LineId",
                        column: x => x.LineId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Routes_TransportLines_TransportLineId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Vehicles_TransportLines_TransportLineId",
                        column: x => x.TransportLineId,
                        principalTable: "TransportLines",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Schedules_TransportLines_TransportLineId",
                        column: x => x.TransportLineId,
                        principalTable: "TransportLines",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ArrivalPredictions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ArrivalPredictions_Stops_StopId",
                        column: x => x.StopId,
                        principalTable: "Stops",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ArrivalPredictions_Vehicles_VehicleId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ArrivalPredictions_StopId",
                table: "ArrivalPredictions",
                column: "StopId");

            migrationBuilder.CreateIndex(
                name: "IX_ArrivalPredictions_VehicleId",
                table: "ArrivalPredictions",
                column: "VehicleId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FavoriteLines_LineId",
                table: "FavoriteLines",
                column: "LineId");

            migrationBuilder.CreateIndex(
                name: "IX_FavoriteLines_UserId_LineId",
                table: "FavoriteLines",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Routes_TransportLineId",
                table: "Routes",
                column: "TransportLineId");

            migrationBuilder.CreateIndex(
                name: "IX_RouteStops_RouteId_OrderIndex",
                table: "RouteStops",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Vehicles_TransportLineId",
                table: "Vehicles",
                column: "TransportLineId");
        }
